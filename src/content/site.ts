...
export const siteConfig: SiteConfig = {
  ...
  poetryMoment: {
    scenes: [
      ...
      },
      {
        ...
        annotation: 'خصوصًا لو اتكتبت على مهل.',
        isOriginal: true
      }
    ]
  },
  ...
  music: {
    heading: 'فيروز في الخلفية',
    invitation: 'شغّلي الجو.',
    trackTitle: 'مزاج قديم',
    trackArtist: 'فيروز وكلاسيكيات في البال',
    audioSrc: undefined,
    playlist: [
      'فيروز — نسم علينا الهوى',
      'فيروز — سألوني الناس',
      'محمد عبد الوهاب — جفنه علّم الغزل'
    ]
  },
  wishes: {
