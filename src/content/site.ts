  ...
  poetryMoment: {
    scenes: [
      ...
      },
      {
        ...
        poetName: 'وأنا',
        verses: [
          'يا لُجينُ، وفي اسمِكِ شيءٌ من قصيدةٍ لم تُكتبْ،',
          'وفي صوتِكِ شيءٌ يجعلُ الليلَ أقلَّ وحشةً.',
          'وفيكِ من الذكاءِ ما يُغري بطولِ الحديثِ،',
          'ومن الجمالِ ما يجعلُ الحديثَ أقلَّ من أن يكفي.',
          'ما جئتُ أزاحمُ قيسًا في ليلاهُ،',
          'ولا امرأَ القيسِ في ليلهِ،',
          'لكنني لو مررتِ بقصائدهم يومًا،',
          'لأعادوا كتابةَ بعضِ ما كتبوا.'
        ],
        annotation: 'أنا لا أكتب لأكون شاعرًا؛ أكتب لأن بعض الناس لا يكفيهم الكلام العادي.',
        isOriginal: true
      }
    ]
  },
